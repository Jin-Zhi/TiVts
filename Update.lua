local iscanupdt, version = "1.3.1a" -- 定义本地脚本版本号

local OSF="/storage/emulated/0/"
local DATA=OSF.."Android/data/"
local N=DATA.."VLine-Ti Vts Lite [v"..veraion.."]-"
...
function CheckUpdate() --定义检查更新函数
    ...
    if iscanupdt ~= version then -- 检查版本如果和云端不符
        ...
        elseif canupdt == 1 then -- 如果更新
            ...
            local downloadurl = "https://raw.githubusercontent.com/Jin-Zhi/TiVts/main/Update.lua" --定义解析链接
